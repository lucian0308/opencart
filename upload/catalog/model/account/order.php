...
class ModelAccountOrder extends Model {
 ...
 . " WHERE order_id = '" . (int)$order_id . "' AND customer_id = '" . (int)$this->customer->getId() . "' AND order_status_id > '0'");
 ...
 . " WHERE zone_id = '" . (int)$order_query->row['shipping_zone_id'] . "'");
	...
	public function getOrders($start = 0, $limit = 20) {
		...
		$query = $this->db->query("SELECT o.order_id, o.firstname, o.lastname, os.name as status, o.date_added, o.total, o.currency_code, o.currency_value FROM `" . DB_PREFIX . "order` o " 
 ...
 . " ORDER BY sort_order");
	...
	public function getOrderHistories($order_id) {
		$query = $this->db->query("SELECT date_added, os.name AS status, oh.comment, oh.notify FROM " . DB_PREFIX . "order_history oh " 
 ...
 . " WHERE order_id = '" . (int)$order_id . "'");
	...
	public function getTotalOrderVouchersByOrderId($order_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order_voucher` " 
 . " WHERE order_id = '" . (int)$order_id . "'");
