...
class ModelPaymentWebPaymentSoftware extends Model {
 ...
 . " WHERE geo_zone_id = '" . (int)$this->config->get('web_payment_software_geo_zone_id') . "' AND country_id = '" . (int)$address['country_id'] . "' AND (zone_id = '" . (int)$address['zone_id'] . "' OR zone_id = '0')");
