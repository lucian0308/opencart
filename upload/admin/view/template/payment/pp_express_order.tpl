                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left"><?php if ($transaction['transaction_id']) { ?>
                            ...
                            <?php } ?>
                            <?php } else { ?>
                            <a onclick="resendTransaction(this);
                                    return false;" href="<?php echo $resend_link . '&paypal_order_transaction_id=' . $transaction['paypal_order_transaction_id']; ?>"><?php echo $text_resend; ?></a>
                            <?php } ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
