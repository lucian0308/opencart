...
class ModelFraudMaxMind extends Model {
	...
	public function getOrder($order_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "maxmind` " 
