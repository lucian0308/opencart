...
class ModelUserUserGroup extends Model {
	...
	public function editUserGroup($user_group_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "user_group SET name = '" . $this->db->escape($data['name']) . "', permission = '" . (isset($data['permission']) ? $this->db->escape(serialize($data['permission'])) : '') . "' " 
 ...
 . " WHERE user_group_id = '" . (int)$user_group_id . "'");
		...
		if ($user_group_query->num_rows) {
			...
			$this->db->query("UPDATE " . DB_PREFIX . "user_group SET permission = '" . $this->db->escape(serialize($data)) . "' " 
 . " WHERE user_group_id = '" . (int)$user_group_id . "'");
		}
	}
