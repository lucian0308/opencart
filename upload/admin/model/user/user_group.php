...
class ModelUserUserGroup extends Model {
	...
	public function editUserGroup($user_group_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "user_group SET name = '" . $this->db->escape($data['name']) . "', permission = '" . (isset($data['permission']) ? $this->db->escape(json_encode($data['permission'])) : '') . "' " 
 ...
 . " WHERE user_group_id = '" . (int)$user_group_id . "'");
	...
	public function getUserGroup($user_group_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "user_group " 
 . " WHERE user_group_id = '" . (int)$user_group_id . "'");
 ...
 . " ORDER BY name";
	...
	public function addPermission($user_group_id, $type, $route) {
		$user_group_query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "user_group " 
 . " WHERE user_group_id = '" . (int)$user_group_id . "'");
		...
		if ($user_group_query->num_rows) {
			...
			$this->db->query("UPDATE " . DB_PREFIX . "user_group SET permission = '" . $this->db->escape(json_encode($data)) . "' " 
 . " WHERE user_group_id = '" . (int)$user_group_id . "'");
		}
	}
