...
class ModelCatalogOption extends Model {
	...
	public function editOption($option_id, $data) {
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', sort_order = '" . (int)$data['sort_order'] . "' " 
 ...
 . " WHERE o.option_id = '" . (int)$option_id . "' AND od.language_id = '" . (int)$this->config->get('config_language_id') . "'");
 ...
 . " ORDER BY sort_order");
		...
		foreach ($option_value_query->rows as $option_value) {
			...
			$option_value_description_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "option_value_description " 
