...
class ModelCatalogProduct extends Model {
 ...
 . " WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getProductFilters($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_filter " 
 . " WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getProductAttributes($product_id) {
		...
		$product_attribute_query = $this->db->query("SELECT attribute_id FROM " . DB_PREFIX . "product_attribute " 
 . " WHERE product_id = '" . (int)$product_id . "' " 
 . " GROUP BY attribute_id");
		...
		foreach ($product_attribute_query->rows as $product_attribute) {
			...
			$product_attribute_description_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_attribute " 
 ...
 . " WHERE po.product_id = '" . (int)$product_id . "' AND od.language_id = '" . (int)$this->config->get('config_language_id') . "'");
		...
		foreach ($product_option_query->rows as $product_option) {
			...
			$product_option_value_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_option_value " 
 . " WHERE product_option_id = '" . (int)$product_option['product_option_id'] . "'");
	...
	public function getProductOptionValue($product_id, $product_option_value_id) {
		$query = $this->db->query("SELECT pov.option_value_id, ovd.name, pov.quantity, pov.subtract, pov.price, pov.price_prefix, pov.points, pov.points_prefix, pov.weight, pov.weight_prefix FROM " . DB_PREFIX . "product_option_value pov " 
 . " LEFT JOIN " . DB_PREFIX . "option_value ov ON (pov.option_value_id = ov.option_value_id) " 
 . " LEFT JOIN " . DB_PREFIX . "option_value_description ovd ON (ov.option_value_id = ovd.option_value_id) " 
 . " WHERE pov.product_id = '" . (int)$product_id . "' AND pov.product_option_value_id = '" . (int)$product_option_value_id . "' AND ovd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
 ...
 . " ORDER BY priority, price");
	...
	public function getProductRewards($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_reward " 
 . " WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getProductDownloads($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_to_download " 
 . " WHERE product_id = '" . (int)$product_id . "'");
 ...
 . " WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getProductRelated($product_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_related " 
 . " WHERE product_id = '" . (int)$product_id . "'");
	...
	public function getRecurrings($product_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "product_recurring` " 
 . " WHERE product_id = '" . (int)$product_id . "'");
 ...
 . " WHERE length_class_id = '" . (int)$length_class_id . "'");
	...
	public function getTotalProductsByDownloadId($download_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "product_to_download " 
 ...
 . " WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
	...
	public function getTotalProductsByAttributeId($attribute_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "product_attribute " 
 . " WHERE attribute_id = '" . (int)$attribute_id . "'");
	...
	public function getTotalProductsByOptionId($option_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "product_option " 
 . " WHERE option_id = '" . (int)$option_id . "'");
	...
	public function getTotalProductsByProfileId($recurring_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "product_recurring " 
 . " WHERE recurring_id = '" . (int)$recurring_id . "'");
	...
	public function getTotalProductsByLayoutId($layout_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "product_to_layout " 
