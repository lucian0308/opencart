...
class ModelLocalisationLanguage extends Model {
 ...
 . " WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
		...
		// Custom Field Value
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value_description " 
 . " WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
 ...
 . " WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
		...
		// Voucher Theme
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "voucher_theme_description " 
 . " WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
 ...
 . " WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
		...
		// Profiles
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "recurring_description " 
 . " WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");
	...
	public function editLanguage($language_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "language SET name = '" . $this->db->escape($data['name']) . "', code = '" . $this->db->escape($data['code']) . "', locale = '" . $this->db->escape($data['locale']) . "', directory = '" . $this->db->escape($data['directory']) . "', image = '" . $this->db->escape($data['image']) . "', sort_order = '" . $this->db->escape($data['sort_order']) . "', status = '" . (int)$data['status'] . "' " 
 . " WHERE language_id = '" . (int)$language_id . "'");
	...
	public function deleteLanguage($language_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "language " 
 . " WHERE language_id = '" . (int)$language_id . "'");
 ...
 . " WHERE language_id = '" . (int)$language_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "filter_group_description " 
 . " WHERE language_id = '" . (int)$language_id . "'");
 ...
 . " WHERE language_id = '" . (int)$language_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "recurring_description " 
 . " WHERE language_id = '" . (int)$language_id . "'");
	...
	public function getLanguage($language_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "language " 
 . " WHERE language_id = '" . (int)$language_id . "'");
