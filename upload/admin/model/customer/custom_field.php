...
class ModelCustomerCustomField extends Model {
	...
	public function editCustomField($custom_field_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "custom_field` SET type = '" . $this->db->escape($data['type']) . "', value = '" . $this->db->escape($data['value']) . "', location = '" . $this->db->escape($data['location']) . "', status = '" . (int)$data['status'] . "', sort_order = '" . (int)$data['sort_order'] . "' " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");

		$this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_description " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_customer_group " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_value " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "custom_field_value_description " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function deleteCustomField($custom_field_id) {
		$this->db->query("DELETE FROM `" . DB_PREFIX . "custom_field` " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "custom_field_description` " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "custom_field_customer_group` " 
 ...
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function getCustomField($custom_field_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "custom_field` cf " 
 . " LEFT JOIN " . DB_PREFIX . "custom_field_description cfd ON (cf.custom_field_id = cfd.custom_field_id) " 
 . " WHERE cf.custom_field_id = '" . (int)$custom_field_id . "' AND cfd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
 ...
 . " WHERE cfd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
			...
			$sql = "SELECT * FROM " . DB_PREFIX . "custom_field_customer_group cfcg " 
 ...
 . " ORDER BY cfd.name";
	...
	public function getCustomFieldDescriptions($custom_field_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_description " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function getCustomFieldValue($custom_field_value_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value cfv " 
 . " LEFT JOIN " . DB_PREFIX . "custom_field_value_description cfvd ON (cfv.custom_field_value_id = cfvd.custom_field_value_id) " 
 . " WHERE cfv.custom_field_value_id = '" . (int)$custom_field_value_id . "' AND cfvd.language_id = '" . (int)$this->config->get('config_language_id') . "'");
	...
	public function getCustomFieldValues($custom_field_id) {
		...
		$custom_field_value_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value cfv " 
 . " LEFT JOIN " . DB_PREFIX . "custom_field_value_description cfvd ON (cfv.custom_field_value_id = cfvd.custom_field_value_id) " 
 . " WHERE cfv.custom_field_id = '" . (int)$custom_field_id . "' AND cfvd.language_id = '" . (int)$this->config->get('config_language_id') . "' " 
 . " ORDER BY cfv.sort_order ASC");
	...
	public function getCustomFieldCustomerGroups($custom_field_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "custom_field_customer_group` " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");
	...
	public function getCustomFieldValueDescriptions($custom_field_id) {
		...
		$custom_field_value_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value " 
 . " WHERE custom_field_id = '" . (int)$custom_field_id . "'");

		foreach ($custom_field_value_query->rows as $custom_field_value) {
			$custom_field_value_description_data = array();

			$custom_field_value_description_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "custom_field_value_description " 
