...
class ModelPaymentFirstdata extends Model {
 ...
 . " WHERE `firstdata_order_id` = '" . (int)$firstdata_order_id . "'");
	}
 ...
 . " WHERE `firstdata_order_id` = '" . (int)$firstdata_order_id . "'");
	...
	public function getOrder($order_id) {
		...
		$qry = $this->db->query("SELECT * FROM `" . DB_PREFIX . "firstdata_order` " 
 . " WHERE `order_id` = '" . (int)$order_id . "' LIMIT 1");
	...
	private function getTransactions($firstdata_order_id) {
		$qry = $this->db->query("SELECT * FROM `" . DB_PREFIX . "firstdata_order_transaction` " 
 . " WHERE `firstdata_order_id` = '" . (int)$firstdata_order_id . "'");
	...
	public function getTotalCaptured($firstdata_order_id) {
		$query = $this->db->query("SELECT SUM(`amount`) AS `total` FROM `" . DB_PREFIX . "firstdata_order_transaction` " 
 . " WHERE `firstdata_order_id` = '" . (int)$firstdata_order_id . "' AND (`type` = 'payment' OR `type` = 'refund')");
