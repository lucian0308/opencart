...
class ModelSaleCustomer extends Model {
    ...
    public function editCustomer($customer_id, $data) {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "customer SET customer_group_id = '" . (int) $data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') . "', newsletter = '" . (int) $data['newsletter'] . "', status = '" . (int) $data['status'] . "', approved = '" . (int) $data['approved'] . "', safe = '" . (int) $data['safe'] . "' "
                . " WHERE customer_id = '" . (int) $customer_id . "'");

        if ($data['password']) {
            $this->db->query("UPDATE " . DB_PREFIX . "customer SET salt = '" . $this->db->escape($salt = substr(md5(uniqid(rand(), true)), 0, 9)) . "', password = '" . $this->db->escape(sha1($salt . sha1($salt . sha1($data['password'])))) . "' "
                    . " WHERE customer_id = '" . (int) $customer_id . "'");
        }
    ...
    public function getAddresses($customer_id) {
        ...
        $query = $this->db->query("SELECT address_id FROM " . DB_PREFIX . "address "
                . " WHERE customer_id = '" . (int) $customer_id . "'");
    ...
    public function getTotalAddressesByCustomerId($customer_id) {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "address "
                . " WHERE customer_id = '" . (int) $customer_id . "'");
    ...
    public function getHistories($customer_id, $start = 0, $limit = 10) {
        ...
        $query = $this->db->query("SELECT comment, date_added FROM " . DB_PREFIX . "customer_history "
                . " WHERE customer_id = '" . (int) $customer_id . "' "
    ...
    public function getTotalTransactions($customer_id) {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_transaction "
                . " WHERE customer_id = '" . (int) $customer_id . "'");
    ...
    public function getTotalIps($customer_id) {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_ip "
                . " WHERE customer_id = '" . (int) $customer_id . "'");
