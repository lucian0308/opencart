...
class ModelDesignBanner extends Model {
	...
	public function editBanner($banner_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "banner SET name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "' " 
 ...
 . " WHERE banner_id = '" . (int)$banner_id . "'");
	...
	public function deleteBanner($banner_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "banner " 
 . " WHERE banner_id = '" . (int)$banner_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "banner_image " 
 . " WHERE banner_id = '" . (int)$banner_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "banner_image_description " 
 . " WHERE banner_id = '" . (int)$banner_id . "'");
	...
	public function getBanner($banner_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "banner " 
 . " WHERE banner_id = '" . (int)$banner_id . "'");
 ...
 . " ORDER BY sort_order ASC");
		...
		foreach ($banner_image_query->rows as $banner_image) {
			...
			$banner_image_description_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "banner_image_description " 
 . " WHERE banner_image_id = '" . (int)$banner_image['banner_image_id'] . "' AND banner_id = '" . (int)$banner_id . "'");
